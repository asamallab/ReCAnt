...
This folder contains the core ReCAnt database as flat `.tsv` files. These files represent both processed data ready for use in analysis and intermediate data used within processing pipelines. They serve as the primary data source across all code in this repository.
...
| `MAIN_species_data.tsv` | Taxonomic and biological data for aquaculture-relevant species |
